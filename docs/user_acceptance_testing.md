...
# 5.2 Test Participants and Environment
...
# 5.3 User Testing Design and Implementation
...
## 5.3.1 Branch A: Gemini Language Model Online Experience and Feedback
...
![image.png](attachment:aa099efe-7315-4053-9516-cabef51fdb26:image.png)

                                                    **fig 1.1 Gemini user experience questionnaire**
...
## 5.3.2 Branch B: Three Speech Frameworks Video Demonstration + Questionnaire Feedback + AHP Multidimensional Evaluation
...
![image.png](attachment:82a863fd-a3d4-4eff-86bf-7beecd6fff68:image.png)

                                                      **fig 1.2 three speech frameworks questionnaire**
...
![image.png](attachment:549cbb36-6d5c-4350-941d-09779c0fdb5b:image.png)

                                                **fig 1.3 Gemini questionnaire feedback visualization**

## 5.4.2 Comprehensive Evaluation of Three Speech Frameworks
...
![image.png](attachment:458b6838-9a12-45cd-a5c8-2481f04123b8:image.png)

                                                           **fig 1.4 AHP analysis results visualization**
...
# 5.5 User Feedback Summary and Suggestions for Improvement
